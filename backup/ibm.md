...
출처:
1. POWER9 SRC B7006A8D or B7006A8E impacting EMXH fanout module adapters
URL: https://www.ibm.com/support/pages/power9-src-b7006a8d-or-b7006a8e-impacting-emxh-fanout-module-adapters
내용: 이 문서에서는 POWER9 서버 환경에서 EMXH(CCIN 50CD, PCIe3 6-slot fanout module)를 사용할 때 FPGA 리셋(SRC B7006A8D 또는 B7006A8E)이 발생하여 해당 모듈에 장착된 하위 PCIe 어댑터들에 EEH 에러나 리셋을 유발할 수 있다고 명시하고 있습니다.

2. FW920.20 and newer: Workaround for SRC=B7006A8D and SRC=B7006A8E EEH errors
URL: https://www.ibm.com/support/pages/fw92020-and-newer-workaround-srcb7006a8d-and-srcb7006a8e-eeh-errors 
내용: 이 문서에서도 EMX0 PCIe Gen3 I/O 확장 드로어 내 팬아웃 모듈의 FPGA 리셋으로 인해 하위 I/O 어댑터에 EEH 에러가 연쇄적으로 발생할 수 있는 원인 및 증상을 구체적으로 설명하고 있습니다.
