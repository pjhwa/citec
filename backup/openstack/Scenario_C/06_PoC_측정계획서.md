...
| Phase | 기간 | 대상 | 작업 | 완료 기준 |
| --- | --- | --- | --- | --- |
| **Phase 0** | Week 1 | 전 환경 | 현황 조사, 프로파일 템플릿 작성 | baseline 수집 완료 |
| **Phase 1** | Week 2~4 | Test (osh1) | Complain → Enforce | 기능/성능/보안 3종 합격 |
| **Phase 2** | Week 5~8 | Dev 전체 | Complain → Enforce (일반 → GPU/HCN 순) | 환경별 프로파일 확정 |
| **Phase 3** | Week 9~12 | 운영 전체 | Canary(1) → 일괄 Complain → Enforce | 전 노드 enforce 모드 |
...
1. 본 계획서 (Phase 0, 1 완료 + 2 계획)
2. Phase 1 증적 패키지 (P1-E1 ~ P1-E5)
3. 프로파일 템플릿 3종

### 10-2. 예비심사 (~5/15)

1. 본 계획서 (Phase 1-2 완료 증적)
2. Phase 2 증적 패키지 (P2-E1 ~ P2-E5)
3. Phase 3 Canary 개시 증적

### 10-3. 본심사 (5/18~22)

1. 본 계획서 (Phase 1-2 완료, Phase 3 진행 중)
2. 전체 증적 패키지 (P1 + P2 + P3-E1~E3)
3. 성능 벤치마크 최종 보고서
4. 외부 벤더 의견서 (확보 시)
