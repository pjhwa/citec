...
- [ ] 운영부서·보안팀·CI-TEC 공동 명의로 v2.0 대응 방침 **결재 완료**
- [ ] PoC Phase 1 (Test 환경 complain 모드) **완료**
- [ ] `aa-status`, `virsh capabilities`, VM별 프로파일 생성 **증적 캡처**
- [ ] 산출물 01~03, 06 **최종 검토**
- [ ] 노브레이크에 **패키지 사전 공유**

### 4-2. 본심사 전까지 (D-30일)

- [ ] PoC Phase 2 (Dev 환경 enforce 모드) **완료**
- [ ] 운영 환경 Canary 노드 (1대) **적용 개시**
- [ ] 산출물 04, 05 **최종본 완성**
- [ ] 경영진·법무 검토 **완료**
- [ ] 피어 CSP(NHN/KT) 비공식 confirm **시도**

### 4-3. 본심사 당일

- [ ] §2-2 4가지 주장 **10분 발표 자료 준비**
