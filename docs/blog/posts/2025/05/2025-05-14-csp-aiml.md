...
|----------------|-------------------|---------------------------------------------------------------------------|---------------------------------------------|----------------------------------------|
| AWS            | Amazon SageMaker  | Unified Studio, 모델 개발/학습/배포, 노트북, SQL 편집기, 생성형 AI 지원 | TensorFlow, PyTorch, Scikit-learn, Keras, Python | 높은 확장성, AWS 서비스 통합            |
...
| NHN 클라우드   | AI EasyMaker      | 모델 학습/배포, 다양한 프레임워크 지원 | 다양한 프레임워크, Python | GPU 리소스 활용                        |
| KT 클라우드    | AI Train          | AI 모델 학습용 웹 UI, GPU 지원 | Python (추정) | AI 서비스 개발 특화                    |
...
| KT 클라우드    | 구체적 서비스 미확인 | AI 추론 서비스 (추정)                 | 명시되지 않음                          |
| SCP            | 구체적 서비스 미확인 | ML 모델 지원 (추정)                   | 명시되지 않음                          |
...
- **네이버 클라우드:** NSML 내 데이터 처리 도구 (추정).
- **NHN 클라우드:** AI EasyMaker 내 데이터 관리 (추정).
- **KT 클라우드:** AI Train 내 데이터 처리 (추정).
- **SCP:** AI&MLOps Platform 내 데이터 관리.

### AutoML

- **AWS:** SageMaker Autopilot, 자동 모델 선택 및 튜닝.
- **Azure:** Azure ML AutoML, GUI 기반 인터페이스.
- **GCP:** Vertex AI AutoML, 코드 없는 학습.
- **한국 CSP:** 명시적 AutoML 기능 미확인.

### MLOps

- 모든 CSP는 모델 버전 관리, 모니터링, 재학습, 배포 도구 제공.
- **SCP:** Kubeflow 기반, 분산 학습 및 추론 관리 강조.
