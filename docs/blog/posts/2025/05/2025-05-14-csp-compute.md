...
|----------------|-----------------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|
| SCP            | Virtual Server, GPU Server, Bare Metal Server, VM Auto-Scaling              | 범용, GPU, 고성능 인스턴스 제공                                       | NVIDIA A100/H100 GPU, 99.999% SLA                                    | 온디맨드, 예약형                                                     | VM Auto-Scaling, 로드 밸런싱                                         |
...
| NHN 클라우드   | Instances (Virtual Servers)                                                 | OpenStack 기반, CentOS, Ubuntu 등 지원                               | 표준 성능, 지역 최적화                                               | 온디맨드, 예약형                                                     | 기본 스케일링 기능                                                   |
| KT 클라우드    | SERVER (Virtual Machines)                                                   | 다양한 워크로드 지원, 통신 최적화                                    | 통신 인프라로 안정적 네트워킹                                       | 온디맨드, 예약형                                                     | Auto-scaling, 네트워크 기반 로드 밸런싱                              |

### 컨테이너 서비스

| CSP            | 주요 서비스                                                                 | 관리형 Kubernetes                                                     | 기타 기능                                                                 | CI/CD 및 DevOps 통합                                                 |
|----------------|-----------------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|
| SCP            | Container Service (추정)                                                    | Kubernetes 기반 (구체적 정보 미확인)                                  | 컨테이너 레지스트리 추정                                             | 삼성 DevOps 도구와 통합 가능                                         |
...
| KT 클라우드    | Kubernetes Service                                                          | 관리형 Kubernetes                                                    | 컨테이너 레지스트리                                                  | 통신 기반 DevOps 통합                                                |

### 서버리스 컴퓨팅

| CSP            | 주요 서비스                                                                 | 지원 언어                                                             | 실행 제한                                                                 | 통합 서비스                                                         |
|----------------|-----------------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|
| SCP            | Cloud Functions (추정)                                                      | Python, JavaScript 추정                                              | 미확인                                                               | SCP 스토리지, 데이터베이스                                           |
...
| 네이버 클라우드 | Serverless Functions                                                        | Python, JavaScript                                                   | 지역 최적화 제한                                                     | Object Storage, CLOVA API                                            |
| NHN 클라우드   | Serverless Functions                                                        | Python, JavaScript                                                   | 표준 제한                                                            | Object Storage, 게임 API                                             |
| KT 클라우드    | Serverless Functions                                                        | Python, JavaScript                                                   | 통신 최적화 제한                                                     | STORAGE, 네트워크 서비스                                             |
