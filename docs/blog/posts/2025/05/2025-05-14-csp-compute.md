...
|----------------|-----------------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|
| SCP            | Virtual Server, GPU Server, Bare Metal Server, VM Auto-Scaling              | 범용, GPU(NVIDIA A100, V100, H100, L40s), 고성능 인스턴스 제공       | NVIDIA A100/H100 GPU, 99.999% SLA                                    | 온디맨드, 예약형                                                     | VM Auto-Scaling, 로드 밸런싱                                         |
| AWS            | EC2 (M7g, C7g, R7g, P5 등)                                                  | 400+ 인스턴스 유형, Graviton 포함                                    | C7g: 64 vCPUs, 128 GiB, 100 Gbps 네트워크                           | 온디맨드, 예약형, 스팟, Savings Plans                                | Auto Scaling, Elastic Load Balancing                                 |
...
| 네이버 클라우드 | Server (Micro, Compact, Standard, High-Memory, GPU, Virtual Dedicated)      | GPU(TESLA V100, T4), 고메모리 포함                                   | 지역 데이터센터로 낮은 지연 시간                                     | 온디맨드, 예약형                                                     | Auto-scaling, 로드 밸런싱                                            |
| NHN 클라우드   | Instances (Virtual Servers), GPU Instances                                  | OpenStack 기반, CentOS, Ubuntu 등 지원, GPU(Nvidia H100) 포함        | 다양한 인스턴스 플레이버, 지역 최적화                                | 온디맨드, 예약형                                                     | 기본 스케일링 기능                                                   |
| KT Cloud       | SERVER (Virtual Machines), GPU Instances                                    | 다양한 워크로드 지원, GPU(AMD Instinct MI250) 포함                  | 통신 인프라 기반 안정성, 고성능 서버 리소스                         | 온디맨드, 예약형                                                     | Auto-scaling, 네트워크 기반 로드 밸런싱                              |

### 컨테이너 서비스

| CSP            | 주요 서비스                                                                 | 관리형 Kubernetes                                                     | 기타 기능                                                                 | CI/CD 및 DevOps 통합                                                 |
|----------------|-----------------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|
| SCP            | Container Service (Kubernetes Engine, Kubernetes Apps)                      | Kubernetes 기반, Kubeflow 지원                                        | 컨테이너 레지스트리, DR 레지스트리 기능                                | 삼성 DevOps 도구와 통합 가능                                         |
...
| KT Cloud       | Kubernetes Service, KCI (Container Instances)                               | 관리형 Kubernetes, 서버리스 컨테이너 지원                            | 컨테이너 레지스트리, OKD 기반                                        | 통신 기반 DevOps 통합                                                |

### 서버리스 컴퓨팅

| CSP            | 주요 서비스                                                                 | 지원 언어                                                             | 실행 제한                                                                 | 통합 서비스                                                         |
|----------------|-----------------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------|
| SCP            | Cloud Functions                                                             | Python, JavaScript, Node.js, Go, Java                                | 15분, 10 GB 메모리                                                     | SCP 스토리지, 데이터베이스, API Gateway                              |
...
| 네이버 클라우드 | Serverless Functions                                                        | Python, JavaScript, Node.js                                          | 지역 최적화 제한, 구체적 정보 없음                                   | Object Storage, CLOVA API                                            |
| NHN 클라우드   | Serverless Functions                                                        | Python, JavaScript, Node.js                                          | 표준 제한, 구체적 정보 없음                                          | Object Storage, 게임 API                                             |
| KT Cloud       | Serverless Functions                                                        | Python, JavaScript, Node.js                                          | 구체적 정보 없음                                                     | STORAGE, 네트워크 서비스                                             |
...
| 네이버 클라우드 | GPU Server                                                                  | TESLA V100, T4 GPU                                                   | 병렬 컴퓨팅 지원                                                    .Concurrent computing support | AI 학습, 데이터 분석                                                 |
| NHN 클라우드   | GPU Instances                                                               | GPU 지원 인스턴스                                                    | 기본 병렬 컴퓨팅                                                     | 게임 렌더링, AI 모델링                                               |
| KT 클라우드    | High-Performance VMs                                                        | GPU 지원 인스턴스                                                    | 통신 기반 병렬 컴퓨팅                                                | 스마트 팩토리, 금융 분석                                             |
...
| 네이버 클라우드 | Edge Computing (추정)                                                       | AI 및 로보틱스 통합                                                  | Cloud IoT Core, IoT Device Hub                                       | Object Storage, CLOVA                                                |
| NHN 클라우드   | Edge Solutions (추정)                                                       | 게임 및 전자상거래 엣지                                              | 애플리케이션 내 IoT 지원                                             | Object Storage, 게임 API                                             |
| KT 클라우드    | Edge Computing (5G 기반)                                                    | 5G 네트워크로 저지연 컴퓨팅                                          | 통신 기반 IoT 연결성                                                 | STORAGE, 네트워크 서비스                                             |
