...
- **시장 점유율**: 
  - Cloud ERP: Oracle 6.63% (2024 기준 1위, 수익 $8.7B로 SAP 추월). Microsoft 4-5% (주요 플레이어지만 3-4위권).
  - Cloud HCM: Oracle 7-8% (3-4위권, Workday 9.8% 1위, Microsoft 7-9% 2위).
  - Cloud CRM: Oracle 3-6% (5-6위권), Microsoft 5-6% (3-4위권, Salesforce 20-23% 1위).
- **기타 검증**: Oracle Fusion Cloud는 2025년 AI 통합으로 성장 중(클라우드 수익 28%↑). Microsoft Copilot은 AI 차별점으로 확인. AWS/Google은 자체 앱 미제공 맞음, Marketplace 중심.
